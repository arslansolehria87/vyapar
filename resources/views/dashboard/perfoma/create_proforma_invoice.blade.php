...
<script>
    ...
    window.proformaIsConverted = false;
    window.proformaConvertedMessage = 'This Data is Converted please close the Tab';
 ...
 window.docType = "proforma";
    ...
    @if(isset($proforma))
        // Edit mode
        window.saleReturnStoreUrl = "{{ route('proforma-invoice.update', $proforma->id) }}";
        window.saleReturnMethod = 'PUT';
        @php
            $saleReturnEditPayload = $proforma->load(['items', 'payments', 'party', 'details']);
        @endphp
        window.editSaleReturnData = @json($saleReturnEditPayload);
        window.editSaleData = window.editSaleReturnData;
        window.saleStoreUrl = window.saleReturnStoreUrl;
        window.saleMethod = window.saleReturnMethod;
        window.proformaIsConverted = @json(($proforma->status ?? 'open') === 'converted');
    ...
    @elseif(isset($duplicateProforma))
        @php
            $duplicateProformaPayload = $duplicateProforma->load(['items', 'payments', 'party', 'details'])->toArray();
            $duplicateProformaPayload['bill_number'] = $nextInvoiceNumber;
            $duplicateProformaPayload['status'] = 'open';
            $duplicateProformaPayload['source_sale_id'] = null;
            $duplicateProformaPayload['reference_id'] = null;
            $duplicateProformaPayload['reference_type'] = null;
        @endphp
        window.isDuplicateSaleReturnMode = true;
        window.editSaleReturnData = @json($duplicateProformaPayload);
        window.editSaleData = window.editSaleReturnData;
        window.saleStoreUrl = window.saleReturnStoreUrl;
        window.saleMethod = window.saleReturnMethod;
        window.proformaIsConverted = false;
